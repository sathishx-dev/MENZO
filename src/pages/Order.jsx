      ...
      <div className="order-items">
        <div className="order-item">
          ...
          <div className="order-info">
            <strong>Charcoal Shirt</strong><br />
            Size: M<br />
            Qty: 1<br />
            ₹1,999
          </div>
